        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              variant={"secondary"}
              className="size-30 xl:size-46 overflow-hidden rounded-full focus:outline-none hover:ring hover:ring-zinc-200 p-0 mb-6 disabled:opacity-100"
            ...
            <FormItem className="mb-0">
              <FormControl>
                <p
                  ...
                  className={cn(
                    "w-full min-w-0 rounded-none border-0 shadow-none px-2 py-2 text-3xl xl:text-4xl! font-black! text-zinc-900 h-fit! wrap-break-word",
                    "truncate whitespace-normal! line-clamp-2! md:line-clamp-3! focus:line-clamp-none focus:whitespace-normal! focus:overflow-visible",
              ...
              <FormControl>
                <p
                  ...
                  className={cn(
                    ...
                    "focus-visible:outline-none focus-visible:ring-0 text-sm! xl:text-lg!",
                    "empty:before:content-[attr(data-placeholder)] empty:before:text-muted-foreground empty:before:block",
                    !isOwner && "cursor-default select-text",
                    isOwner && "cursor-text"
                  )}
